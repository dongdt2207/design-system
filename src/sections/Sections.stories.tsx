...
export const FullPage: StoryObj = { name: '0. Trang hoàn chỉnh — Ebig CDN', render: () => renderLanding(s), decorators: [] };
...
export const FeatureLeft: StoryObj = { name: '5b. Feature — visual trái', render: () => <FeatureFullBleed {...pick('feature', 1)} /> };
